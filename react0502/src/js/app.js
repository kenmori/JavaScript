...
var Hello = React.createClass({displayName: "Hello",
  ...
  render: function() {
    var value = React.createElement("span", {className: "sample", key: this.state.value}, this.state.value);
    return (
      React.createElement("div", null, 
        React.createElement("div", null, "Animation!!", React.createElement("button", {onClick: this.onClick}, "click!!")), 
        React.createElement(CSSTransitionGroup, {transitionName: "sample"}, 
          value
        )
      )
    );

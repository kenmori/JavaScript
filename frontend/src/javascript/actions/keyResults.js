...
const actions = createActions({
  ...
  [actionTypes.FETCHED_KEY_RESULTS]: keyResults =>
    normalizeKeyResults(keyResults),
  [actionTypes.FETCH_KEY_RESULT_CANDIDATES]: (okrPeriodId, userId) => ({
    okrPeriodId,
    userId,
  }),
  [actionTypes.FETCHED_KEY_RESULT_CANDIDATES]: keyResults =>
    normalizeKeyResults(keyResults),
  ...
  [actionTypes.UPDATED_KEY_RESULT]: (keyResult, currentUserId) =>
    normalizeKeyResult(keyResult).set("currentUserId", currentUserId),
  ...
  [actionTypes.FETCHED_KEY_RESULT_HISTORY]: (id, histories) => ({
    id,
    histories,
  }),

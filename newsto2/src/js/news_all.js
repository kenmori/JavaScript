!(function($) {
    ...
    try {
        if (storageTabNumber !== null || storageTabNumber !== undefined) {
            ...
            //ここから追記 20150313 kanahara
            if($('.arrowon').children().hasClass('t-scroll-tabs__nav--active')) {
                //arrowonクラスのついたliの中のa要素にt-scroll-tabs__nav--activeがあれば

                //この中はスマパストップのmain.jsから拝借
                ...
                //ここまでスマパスのmain.jsから拝借
            }
            else {
                $('.js-timeline__tab-arrow').css('display', 'none');
                //違えばtimeline__tab-arrow.js-timeline__tab-arrowを非表示にする
            }
            //ここまで追記 20150313 kanahara
        }
    ...
    if (UA.deviceType == 'android') {
        ...
        if (UA.osVersion < 3) {
            ...
            $('.js-timeline__tab').overflowScroll();
        }
    }

    ...
    Menu.prototype.init = function() {
      ...
      this.serviceList.addListener('load', (function(_this) {
        return function() {
          ...
          return _this.fire('service_list_load');
        };
      })(this));
      ...
      this.adSlot.addListener('load', (function(_this) {
        return function() {
          return _this.fire('ad_slot_load');
        };
      })(this));
    ...
    Link.prototype.open = function() {
      ...
      if (scheme !== 'http' && scheme !== 'https') {
        ...
        if (navigator.userAgent.indexOf('iPhone' > 0)) {
          ...
          Synapse.Navigation.redirect(this.url);
          return timer = setTimeout(this._fallback, 2000);
        }
      } else {
...
(function() {
  ...
  Synapse.AdSlot = (function(_super) {
    ...
    AdSlot.prototype.trackShowEvent = function() {
      return this._beaconDiv.innerHTML = this._beaconHTML;
    };
...
**************************/
    $(document).ready(function(){
      ...
      // メニューインスタンスの作成
      menu = new Synapse.Menu('synapse_dev_side_menu');
    //menu = new Synapse.Menu('a3_news_side_menu');
      ...
      menu.addListener('service_list_load', function(){
        menu.serviceList.serviceListItems.forEach(function(item){
          ...
          $(itemElement).one('inview', function(){ item.trackShowEvent() });
      ...
      menu.addListener('ad_slot_load', function(){
        ...
        $(adElement).one('inview', function(){ menu.adSlot.trackShowEvent() })
      });

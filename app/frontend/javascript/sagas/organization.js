...
function* fetchOrganization({ payload }) {
  ...
  yield put(
    organizationActions.fetchedOrganization(result.get("organization")),
  );
}
...
function* updateOrganization({ payload: { organization } }) {
  ...
  yield put(
    organizationActions.updatedOrganization(result.get("organization")),
  );
...
function* updateOrganizationOwner({ payload }) {
  ...
  yield put(
    organizationActions.updatedOrganizationOwner(result.get("ownerId")),
  );

...
export const validateObjectiveName = value => (value ? undefined : 'Objective を入力してください')
...
export const validateParentKeyResultId = value => (value && value !== -1
  ? undefined
  : '上位 Key Result を選択してください')

export const validateKeyResultName = value => (value ? undefined : 'KeyResult を入力してください')
...
export const validateExpiredDate = value => (moment(value, 'YYYY/M/D').isValid() ? undefined : '期限が不正です')

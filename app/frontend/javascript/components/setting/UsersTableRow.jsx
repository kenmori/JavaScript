...
class UsersTableRow extends PureComponent {
  ...
  handleAdminChange = (event, { checked }) =>
    this.props.updateUser({ admin: checked });

  handleOwnerChange = () =>
    this.props.setOrganizationOwner(this.props.organizationId, this.props.user);
          ...
          {user.get("isConfirming") &&
            (disabled ? (
              ...
              <Label
                ...
                content="確認中"
                as="a"
                onClick={this.handleResendClick(user)}
              />
            ))}
        </Table.Cell>
        <Table.Cell>

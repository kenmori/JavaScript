...
const actions = createActions({
  ...
  [actionTypes.FETCH_UNPROCESSED_KEY_RESULTS]: (okrPeriodId, userId) => ({ okrPeriodId, userId }),
  [actionTypes.FETCHED_UNPROCESSED_KEY_RESULTS]: keyResults => normalizeKeyResults(keyResults),

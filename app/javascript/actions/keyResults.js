...
const actions = createActions({
  ...
  [actionTypes.FETCH_KEY_RESULT_TASKS]: (okrPeriodId, userId) => ({ okrPeriodId, userId }),
  [actionTypes.FETCHED_KEY_RESULT_TASKS]: keyResults => normalizeKeyResults(keyResults),
